!sessionStorage.getItem("_lp_s")&&!window.__lp_blocked&&location.replace("/");if(sessionStorage.getItem("_lp_s")){if(sessionStorage.getItem("_lp_fade")){sessionStorage.removeItem("_lp_fade");const e=document.createElement("div");e.style.cssText="position:fixed;top:0;left:0;width:100%;height:100%;background:#fff;z-index:1000;animation:lpFadeOut 2s ease-in-out forwards",document.body.appendChild(e),e.addEventListener("animationend",()=>e.remove())}const t=document.createElement("link");t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;1,400;1,500&family=Inter:wght@400;500&display=swap",document.head.appendChild(t);const o=document.createElement("style");o.textContent=`
@keyframes lpFadeOut {
  from { opacity: 1 }
  to { opacity: 0 }
}
...
`,document.head.appendChild(o),document.body.insertAdjacentHTML("beforeend",`
  <div class="lp-hero">
...
`),document.querySelectorAll(".lp-nav a").forEach(e=>{e.addEventListener("click",r=>{r.preventDefault();const a=document.querySelector(e.getAttribute("href"));a&&a.scrollIntoView({behavior:"smooth",block:"start"})})})}
