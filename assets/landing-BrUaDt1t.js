!sessionStorage.getItem("_lp_s")&&!window.__lp_blocked&&location.replace("/");if(sessionStorage.getItem("_lp_s")){if(new URLSearchParams(window.location.search).has("fadeIn")){const e=document.createElement("div");e.style.cssText="position:fixed;top:0;left:0;width:100%;height:100%;background:#fff;z-index:1000;animation:lpFadeOut 2s ease-in-out forwards",document.body.appendChild(e),e.addEventListener("animationend",()=>e.remove())}const t=document.createElement("link");t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;1,400;1,500&family=Inter:wght@400;500&display=swap",document.head.appendChild(t);const o=document.createElement("style");o.textContent=`
@keyframes lpFadeOut {
  from { opacity: 1 }
  to { opacity: 0 }
}
